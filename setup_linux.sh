...
BASEPACKAGES="sudo curl wget git unzip file dbus bc bash-completion hdparm sysstat less vim iptables ipset pciutils iperf3 net-tools jq haveged htop zsh tmux neofetch lshw iotop rsync tree autojump bat lm-sensors cargo"
