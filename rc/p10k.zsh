# Generated by Powerlevel10k configuration wizard on 2022-02-22 at 15:40 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    mill_version            # Shows Mill Scala build tool version from `prompt_mill_version` function in scala.sh
    bleep_version           # Shows Bleep Scala build tool version from `prompt_bleep_version` function in scala.sh
